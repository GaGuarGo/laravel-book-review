...
class Book extends Model
{
    ...
    private function dateRangeFilter(Builder $query, string $from, string $to)
    {
    ...
    {
        return $query->highestRated(now()->subMonths(6), now())->popular(now()->subMonths(6), now())->minReviews(2);
    }
}
